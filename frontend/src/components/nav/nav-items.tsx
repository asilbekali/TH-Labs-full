...
export const NAV: { to: string; label: string; icon: ReactNode }[] = [
  { to: '/', label: 'Home', icon: <path d="M3 10.5 12 3l9 7.5M5 9.5V20a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9.5" /> },
  { to: '/studio', label: 'Studio', icon: <path d="M12 3a3 3 0 0 0-3 3v6a3 3 0 0 0 6 0V6a3 3 0 0 0-3-3zM5 11a7 7 0 0 0 14 0M12 18v3" /> },
  {
    to: '/works',
    label: 'My works',
    icon: (
      <>
        ...
        <path d="M11 11.2v4l3.4-2z" />
      </>
    ),
  },
  { to: '/plans', label: 'Plans', icon: <path d="M3 7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM3 10h18M7 15h4" /> },
]
