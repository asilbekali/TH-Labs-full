                ...
                <>
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute inset-0 rounded-full bg-[rgb(11_11_12)] dark:bg-brand"
                    />
                  )}
                  {!isActive && <span className="absolute inset-0 rounded-full bg-sunken transition-colors group-hover/nav:bg-subtle" />}
                  {/* Active: a cream glyph on the ink pill in light mode, and
                      an ink glyph on the bright violet pill in dark — the fill
